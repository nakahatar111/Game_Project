class Game2 extends Phaser.Scene{
	...
	preload(){
		...
		this.load.image('bg4','visual/gamemap4.png');
	...
	create(){
		...
		//bg image
		this.back = this.add.image(0, 0, 'bg4').setScale(1.7).setOrigin(0, 0);

		//map
		this.cameras.main.setBounds(0, 0, 1660, 1730);
		this.minimap = this.cameras.add(550, 10000, 250, 150).setZoom(0.5);
		this.minimap.setBounds(0, 0, 1180, 680);
		this.physics.world.setBounds(0, 0, 1660, 1730, true, true, true, true);
		...
		area.create(150,250, 'area').setScale(1).refreshBody();
		area.create(100,250, 'area').setScale(1).refreshBody();
		area.create(100,0, 'area').setScale(1).refreshBody();
		area.create(300,0, 'area').setScale(1).refreshBody();
		area.create(400,0, 'area').setScale(1).refreshBody();
		area.create(620,100, 'area').setScale(1).refreshBody();
		area.create(620,200, 'area').setScale(1).refreshBody();
		area.create(620,300, 'area').setScale(1).refreshBody();
		area.create(500,400, 'area').setScale(0.3).refreshBody();
		area.create(480,430, 'area').setScale(0.3).refreshBody();
        area.create(450,450, 'area').setScale(0.3).refreshBody();
		area.create(420,450, 'area').setScale(0.3).refreshBody();
		area.create(390,450, 'area').setScale(0.3).refreshBody();
		area.create(360,450, 'area').setScale(0.3).refreshBody();
		area.create(320,459, 'area').setScale(0.2).refreshBody();
		area.create(80,480, 'area').setScale(0.5).refreshBody();
		area.create(-5,420, 'area').setScale(0.5).refreshBody();
		area.create(-5,580, 'area').setScale(0.5).refreshBody();
		area.create(-5,630, 'area').setScale(0.5).refreshBody();
		area.create(-5,690, 'area').setScale(0.5).refreshBody();
		area.create(330,530, 'area').setScale(0.5).refreshBody();
		area.create(390,530, 'area').setScale(0.5).refreshBody();
		area.create(500,510, 'area').setScale(0.5).refreshBody();
		area.create(700,510, 'area').setScale(1).refreshBody();
		area.create(940,450, 'area').setScale(1).refreshBody();
		area.create(1100,380, 'area').setScale(1).refreshBody();
		area.create(1240,450, 'area').setScale(1).refreshBody();
		area.create(1400,650, 'area').setScale(1).refreshBody();
		area.create(1300,800, 'area').setScale(0.7).refreshBody();
		area.create(1160,780, 'area').setScale(0.9).refreshBody();
		area.create(1160,820, 'area').setScale(0.9).refreshBody();
		area.create(1400,1020, 'area').setScale(0.9).refreshBody();
		area.create(1230,1080, 'area').setScale(0.7).refreshBody();
		area.create(1010,1020, 'area').setScale(0.5).refreshBody();
		area.create(1100,1040, 'area').setScale(0.1).refreshBody();
		area.create(1130,1040, 'area').setScale(0.1).refreshBody();
		area.create(970,780, 'area').setScale(0.5).refreshBody();
		area.create(690,800, 'area').setScale(0.5).refreshBody();
		area.create(340,800, 'area').setScale(0.5).refreshBody();
		area.create(10,980, 'area').setScale(0.5).refreshBody();
		area.create(420,780, 'area').setScale(0.1).refreshBody();
		area.create(440,780, 'area').setScale(0.1).refreshBody();
		area.create(480,780, 'area').setScale(0.1).refreshBody();
		area.create(510,780, 'area').setScale(0.1).refreshBody();
		area.create(550,780, 'area').setScale(0.1).refreshBody();
		area.create(600,780, 'area').setScale(0.1).refreshBody();
        
		area.create(660,1060, 'area').setScale(0.9).refreshBody();
		area.create(630,1060, 'area').setScale(0.9).refreshBody();
		area.create(500,1015, 'area').setScale(0.5).refreshBody();
		area.create(420,1015, 'area').setScale(0.5).refreshBody();
		area.create(360,1100, 'area').setScale(0.5).refreshBody();
		
        area.create(120,1060, 'area').setScale(0.8).refreshBody();
        area.create(100,1120, 'area').setScale(0.8).refreshBody();
        area.create(120,1300, 'area').setScale(0.8).refreshBody();
        area.create(180,1440, 'area').setScale(0.8).refreshBody();
        area.create(160,1600, 'area').setScale(0.8).refreshBody();
        area.create(600,1500, 'area').setScale(0.5).refreshBody();
        area.create(600,1300, 'area').setScale(0.5).refreshBody();
        area.create(400,1700, 'area').setScale(1).refreshBody();
        area.create(560,1700, 'area').setScale(1).refreshBody();
        area.create(800,1700, 'area').setScale(1).refreshBody();
        area.create(800,1500, 'area').setScale(1).refreshBody();
        
		area.create(1130,1160, 'area').setScale(0.1).refreshBody();
		area.create(1100,1160, 'area').setScale(0.1).refreshBody();
		area.create(1050,1160, 'area').setScale(0.1).refreshBody();
		area.create(1000,1160, 'area').setScale(0.1).refreshBody();
        
		area.create(1500,850, 'area').setScale(1).refreshBody();
		area.create(1500,1050, 'area').setScale(1).refreshBody();
		area.create(1500,1250, 'area').setScale(1).refreshBody();
		
        area.create(800,1360, 'area').setScale(1).refreshBody();
        area.create(1050,1360, 'area').setScale(1).refreshBody();
        area.create(1170,1360, 'area').setScale(1).refreshBody();
        area.create(1470,1360, 'area').setScale(1).refreshBody();
        area.create(1470,1500, 'area').setScale(1).refreshBody();
        area.create(1500,1650, 'area').setScale(1).refreshBody();
        area.create(1300,1720, 'area').setScale(0.4).refreshBody();
        area.create(1170,1650, 'area').setScale(1).refreshBody();
        area.create(1170,1500, 'area').setScale(1).refreshBody();
		...
		//main character
		kid = this.physics.add.sprite(200,410, 'character').setDepth(0);
		...
		//enemy character
			...
			zombie = this.physics.add.sprite(450,1550,'zombie');
			...
			if (gameWin)
				{
					...
					if(this.key_enter.isDown){
						...
						$.get( "Admin/index.php?score="+ playerscoretime + "&level=3" , function( data ) {
	...
	pausegame(){
		...
		this.scene.launch('PauseScreen2');
		this.scene.pause();
        }
